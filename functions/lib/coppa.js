...
exports.parentDataAccess = exports.verifyParentalConsent = exports.processEmailQueue = exports.handleExpiredConsents = exports.checkConsentExpiration = exports.enforceDataRetention = void 0;
    ...
    try {
        ...
        oldPhotosSnapshot.forEach((doc) => {
            ...
            if (photoData.storagePath) {
                ...
                deletePromises.push(file.delete().catch((error) => {
 ...
 */
exports.checkConsentExpiration = functions.pubsub
    .schedule('every 24 hours')
    .timeZone('America/New_York')
    .onRun(async (context) => {
    ...
    try {
        ...
        expiringConsentsSnapshot.forEach((doc) => {
            ...
            emailPromises.push(db.collection('email_queue').add({
 ...
 */
exports.handleExpiredConsents = functions.pubsub
    .schedule('every 24 hours')
    .timeZone('America/New_York')
    .onRun(async (context) => {
 ...
 */
exports.verifyParentalConsent = functions.https.onRequest(async (req, res) => {
 ...
 */
exports.parentDataAccess = functions.https.onRequest(async (req, res) => {
    var _a;
    res.set('Access-Control-Allow-Origin', '*');
    ...
    try {
        ...
        if (!childDoc.exists || ((_a = childDoc.data()) === null || _a === void 0 ? void 0 : _a.parentId) !== parentId) {
        ...
        switch (action) {
            case 'export': {
                ...
                const exportData = {
                    ...
                    tasks: tasks.docs.map(d => (Object.assign({ id: d.id }, d.data()))),
                    rewards: rewards.docs.map(d => (Object.assign({ id: d.id }, d.data()))),

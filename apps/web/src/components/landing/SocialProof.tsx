  ...
  return (
    <>
            ...
            <div className="flex items-center space-x-2">
              <div className="flex">
                {[...Array(5)].map((_, i) => (
                  <svg
                    key={i}
                    className={`w-5 h-5 ${i < 4 ? 'text-accent' : 'text-neutral-300'}`}
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <p className="text-center text-sm text-neutral-500 mb-6 uppercase tracking-wider">As Featured In</p>
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 opacity-60">
            <img src="/images/press/techcrunch.svg" alt="TechCrunch" className="h-8" loading="lazy" />
            <img src="/images/press/forbes.svg" alt="Forbes" className="h-8" loading="lazy" />
            <img src="/images/press/parenting.svg" alt="Parenting Magazine" className="h-8" loading="lazy" />
            <img src="/images/press/fastcompany.svg" alt="Fast Company" className="h-8" loading="lazy" />
            <img src="/images/press/wired.svg" alt="Wired" className="h-8" loading="lazy" />
          </div>
        </div>
      </section>
